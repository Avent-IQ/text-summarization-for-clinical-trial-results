# Text-to-Text Transfer Transformer Quantized Model for Text summarization for Clinical Trial Results
...
- **Task:** Text summarization for Clinical Trial Results
...
model_name = "AventIQ-AI/text-summarization-for-clinical-trial-results"
